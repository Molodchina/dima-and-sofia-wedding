...
Через админку можно создавать и редактировать приглашения до 20 гостей, генерировать безопасный slug, копировать персональную ссылку вида `https://dmitrii-sofia-wedding.ru/?invite=...`, включать/выключать приглашение и удалять его с подтверждением. Удаление приглашения также удаляет связанный RSVP-ответ на стороне БД.
